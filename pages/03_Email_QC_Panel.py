...
from lib.top_strip import render_top_strip          # your existing top strip
from lib.qc_state import render_reference_and_editor  # editor + reference cards

def main():
    # 1) Top strip: date/time + Save / Complete / Next + link/file inputs
